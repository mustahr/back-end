...
export const CellAction: React.FC<CellActionProps> = ({
    ...
    const onCopy = (id: string, name: string) => {
        ...
        toast(`Trip ${name} Id copied to the clipboard.`, {
    ...
    const onDelete = async () => {
        try {
            setLoading(true);
            await axios.delete(`/api/trips/${data.id}`);
            router.refresh();
        ...
        <>
            ...
            <DropdownMenu>
                ...
                <DropdownMenuContent align="end">
                    ...
                    <DropdownMenuItem onClick={() => onCopy(data.id, data.title)}>
                        <Copy className="mr-2 h-4 w-4" />
                        Copy Id
                    </DropdownMenuItem>
                    <DropdownMenuItem onClick={() => router.push(`/trips/${data.id}`)}>
